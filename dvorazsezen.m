% Ob?utljivost dvorazse?nega celo?tevilskega linearnega problema.
...
% ho?emo maksimizirat funkcijo fun(x,y)=4x+6y, pri pogojih y-3x<=6, y+2x<=10
% in x,y sta pozitivni celi ?tevili.

% b spremenimo iz [3,10] -> [3,8]
Viz1=figure; % Vpliv omejitvenega vektorja
fill3([1,1,7/5,9/2]',[1,6,36/5,1]',[0,0,0,0]','y'); %Dopustne re?itve
hold on
fill3([1,1,7/5,9/2]',[1,6,36/5,1]',[2,32,188/5,-12]','r'); %Vrednost namenske funkcije
fill3([1,1,7/2]',[1,6,1]',[0,0,0]','o'); %Dopustne resitve po spremembi drugega koeficjenta b
fill3([1,1,7/2]',[1,6,1]',[2,32,-8]','g'); %Vrednost namenske funkcije po spremembi drugega koeficjenta b 
xlabel('x');
ylabel('y');
